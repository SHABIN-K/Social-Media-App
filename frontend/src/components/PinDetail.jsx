          ...
          <div className="w-full p-5 flex-1 xl:min-w-620">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                rel="noreferrer"
                className="flex items-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
              >
            ...
            >
              <img
                src={pinDetail?.postedBy?.image?.options?.source}
            ...
            <div className="max-h-370 overflow-y-auto">
              {pinDetail?.comments?.map((item, index) => (
                ...
                >
                  <img
                    src={item.postedBy?.image?.options?.source}
